...
# Platform
PRODUCT_PLATFORM := asahi

include device/sony/asahi/PlatformConfig.mk

TARGET_BOOTLOADER_BOARD_NAME := unknown
ifneq (,$(filter %xqec54,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := XQ-EC54
else
TARGET_BOOTLOADER_BOARD_NAME := XQ-EC54
...
# Kernel cmdline
BOARD_BOOTCONFIG += androidboot.hardware=pdx245
BOARD_KERNEL_CMDLINE += androidboot.fstab_suffix=pdx245
...
# Reserve space for data encryption (0x35E7AA5000-0x4000)
